classdef Validated_Solution 
    ...
    methods
        function obj = Validated_Solution(Rom,BB_Sol,Validated_BB_Settings)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%
    methods(Static)
        function Solution = update_validated_solution(Solution,Analysis_Output)
