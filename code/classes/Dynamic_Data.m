classdef Dynamic_Data
    ...
    methods
        ...
        function obj = analyse_h_solution(obj,r,r_dot,h,h_dot,orbit_stability,Validation_Analysis_Inputs,solution_num,orbit_num)
            ...
            H_Force_Poly = Validation_Analysis_Inputs.H_Force_Poly;
            num_r_modes = size(r_energy,1);
            q = [r_energy;h_disp_energy];
            h_force = H_Force_Poly.evaluate_polynomial(q);
            h_potential = sum(1/2*h_force((num_r_modes+1),:).*h_disp_energy,1);
