...
for iX = 1:num_x
    ...
    damping_term = (r_dr_damping_prod*r_dr_products_coupling +Damping_Data.damping_r)*r_dot_i;
    ...
    damping_term_dr_dot = (r_dr_damping_prod*r_dr_products_coupling +Damping_Data.damping_r);
    %-------------
    switch force_type
        case "modal"
