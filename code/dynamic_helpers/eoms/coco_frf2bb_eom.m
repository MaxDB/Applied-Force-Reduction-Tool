function x_dot = coco_frf2bb_eom(t,x,epsilon,force_amp,period,input_order,Force_Data,Disp_Data,Damping_Data,Applied_Force_Data)
num_x = size(x,2);
...
for iX = 1:num_x
    ...
    %--
    x_dot(vel_span,iX) = -inertia_term\(convection_term+restoring_force + epsilon_i*(damping_term - applied_force));
end
